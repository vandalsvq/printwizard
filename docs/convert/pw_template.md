...
| НаборыПредставления   | [pw#template#dataset#wizards#row][9] | Настройки формирования ПолеКонструктора | 5.0 * |
| НаборыНумераторы      | [pw#template#dataset#numerators#row][10] | Настройки формирования ПолеНумератора | 5.0 * |
...
| ОбластиПредставления  | [pw#template#area#wizards#row][14] | Настройки формирования ПолеКонструктора параметра области | 5.0 * |
...
| КлючСтрокиПоля          | Строка | Уникальный ключ поля | 5.0 |
| КлючСтрокиПоляВладелец  | Строка | Уникальный ключ поля-владельца, для полей с типом "ПолеСвойства" | 5.0 |
...
| СвойствоТип             | Строка | Строковое представление типа данных свойства | 5.0 |
| ЭтоПолеПечати           | Булево | Поле, рекомендованное для печатной формы | 5.0 |
| ТипДанных               | Строка | Строковое представление типа данных в поле | 5.0 |
...
|--|--|--|--|
| НомерСтроки     | Число | Порядковый номер | 5.0 |
| КлючСтрокиПоля  | Строка | Уникальный ключ поля-владельца | 5.0 |
| ИмяПоля         | Строка | Имя поля из набора | 5.0 |
| Префикс         | Строка | Префикс, для подстановки перед значением поля | 5.0 |
| Формат          | Строка | Настройка форматирования значения | 5.0 |
...
| КлючСтрокиНабора          | Строка | Ключ набора, для параметра с типом ЗначениеНабора | 5.0 |
| ЗначениеПараметра         | Строка | Значение для заполнения в наборе | 5.0 |
| ФорматЗначения            | Строка | Настройка форматирования значения, перед установкой в параметр | 5.0 |
...
|--|--|--|--|
| НомерСтроки           | Число | Порядковый номер | 5.0 |
| КлючСтрокиПараметра   | Строка | Ключ параметра-владельца | 5.0 |
