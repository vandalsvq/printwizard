...
description: "Условия использования PrintWizard Community версии: расширение 1С с открытым кодом под лицензией Apache 2.0, обработка данных, сбор анонимной статистики и ограничение ответственности."
sidebar:
  hidden: true
---
...
Вы можете выбрать ранний доступ, бета-версию или ночную версию продукта в рамках программы раннего доступа Энспейс. Это позволяет вам попробовать предварительные версии и оценить новый функционал. такое использование регулируется Пользовательским соглашением Энспейс (ранний доступ) (см. [здесь](/licensing/user-eap/)). Если вы прекратите использовать продукт раннего доступа, но продолжите использовать Community версию, такое использование будет по-прежнему регулироваться настоящими условиями.
