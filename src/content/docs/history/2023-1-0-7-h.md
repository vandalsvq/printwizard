---
title: "2023 - 1.0.7.х"
description: "Что нового в PrintWizard 1.0.7.х: механизм сравнения макетов с подсветкой изменений, универсальный сериализатор данных, проверка связи полей и новый формат выгрузки pdwx 4.0."
---
