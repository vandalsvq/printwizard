---
title: "XML-схема"
description: "Унифицированная XML-схема макета PrintWizard версии 6.1: структура элемента Template, объекты, запросы, наборы, области, события, функции и допустимые значения перечислений."
sidebar:
  order: 2
---
...
│     └── OutputRules[]     — условия вывода области (без BSL)
...
| `ComparisonType` | Вид сравнения — см. [перечисление](#filteritemcomparisontypes--виды-сравнения) |
...
Используется в `Area.OutputRule/ComparisonType`. Имена и состав соответствуют типовому 1С-перечислению `ВидСравненияКомпоновкиДанных` (`DataCompositionComparisonType`).
