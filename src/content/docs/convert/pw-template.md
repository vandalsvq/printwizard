---
title: "pw#template"
description: "Внутренняя структура макета печатной формы PrintWizard pw#template: реквизиты, таблицы запросов, наборов, областей, параметров, событий и функций с указанием версий экспорта."
sidebar:
  hidden: true
---
...
* "х.х *" - при экспорте изменяется, подробнее см. в [pw#template#file](/convert/pw-template-file/)
...
| ЗначениеJSON            | Строка | Настройка поля в JSON, подробнее см. [pw#field#...](/convert/pw-field-json/) | 5.0 |
...
| ЗначениеJSON              | Строка | Настройка параметра в JSON, подробнее см. [pw#field#...](/convert/pw-field-json/) | 5.0 |
| ЗначениеТекст             | Строка | Представление настройки параметра | 5.0 |
| ФорматЗначения            | [pw#format#all](/convert/pw-format/#pwformatall) | Настройка форматирования значения, перед установкой в параметр | 5.1 |
