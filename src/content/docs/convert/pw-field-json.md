---
title: "pw#field#..."
description: "Справочник структур pw#field PrintWizard для хранения настроек полей макета в ЗначениеJSON: свойства, контактная информация, представление, нумератор, QR-код, сумма прописью."
sidebar:
  hidden: true
---
...
| Формат            | [pw#format#all](/convert/pw-format/#pwformatall) | Настройка форматирования значения поля | 5.1 |
| КлючСтрокиПоля    | Строка | Ключ строки поля-владельца | 5.0 |
| КлючСтрокиНабора  | Строка | Ключ строки набора поля-владельца | 5.0 |
