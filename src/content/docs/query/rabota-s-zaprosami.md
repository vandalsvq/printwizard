...
description: "Введение в работу с запросами 1С в PrintWizard: виды запросов, синтаксис ВЫБРАТЬ-ИЗ-ГДЕ, группировка и агрегаты, виртуальные таблицы регистров и конструктор запросов для печатных форм."
sidebar:
  hidden: true
---
...
![Кнопка вызова конструктора запросов](/img/query/knopka-konstruktor-zaprosa.png).
