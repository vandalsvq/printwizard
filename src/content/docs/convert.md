...
Более подробное описание контрактов описано в [pw#template](/convert/legacy-format/#контракты-макета-pwtemplate).

## Структура для экспорта

Структура содержит данные для преобразования в формат JSON и дальнейшего сохранения в ***.pdwx** файл. Все таблицы имеют тип "Массив", а ссылочные данные преобразованы в простые типы. Формат структуры: [pw#template#file](/convert/legacy-format/#файл-экспорта-pwtemplatefile).
